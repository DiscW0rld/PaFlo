...
public class DefinitionsabfrageAuswahl extends AppCompatActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        hilfe = (ImageButton) findViewById(R.id.imageButton);
        hilfe.setVisibility(View.VISIBLE);
        hilfe.setClickable(true);
        ...
        startDefinition.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(ce == R.id.start_datei){
                    ...
                    Intent intent = new Intent(DefinitionsabfrageAuswahl.this, Definitionsabfrage.class);
        ...
        downloadDefinition.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(ce == R.id.download_datei){
                    ...
                    Intent intent = new Intent(DefinitionsabfrageAuswahl.this, DownloadActivity.class);
                    startActivity(intent);
